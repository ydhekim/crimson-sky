...
public class KryoPacketRouterFactory implements PacketRouterFactory {
    ...
    public PacketRouter create(ServiceRegistry serviceRegistry) {
        return new KryoPacketRouter(
            ...
            serviceRegistry.getRewardService(),
            serviceRegistry.getSkillTreeService(),
            serviceRegistry.getShopService(),
            serviceRegistry.getQuestService(),
            serviceRegistry.getLadderService(),
            serviceRegistry.getCharacterPageService(),
