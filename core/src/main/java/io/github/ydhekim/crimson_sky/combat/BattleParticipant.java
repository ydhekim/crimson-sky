...
public class BattleParticipant {
     ...
     * §4.4; the first loadout pet with battle-scoped HP) and a zeroed {@link BattleStateComponent}.
     * The entity is added to {@code engine} so its lifecycle is owned there.
     */
