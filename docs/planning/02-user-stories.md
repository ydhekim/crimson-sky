...
Last updated: 2026-07-09 (M3 async-attack pass: B4 marked done — `AttackRequest`/`AttackResponse`, `AttackService`, `BotFactory`, `BattleEngine` turn history; the B1 live queue and its packets/registry deleted. Previously: B1 matchmaking pass, and the M2 combat-core pass — A1 revisited + A2/A3/A5/A7/B2/B3)
