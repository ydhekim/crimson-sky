...
Last updated: 2026-07-11 (M3 reward-persistence pass: C1/C2/C3 marked done — `RewardService` + `V8__Battle_History.sql`, reward deltas added to `AttackResponse`. Previously: the M3 async-attack pass — B4 done, the B1 live queue and its packets/registry deleted; the B1 matchmaking pass; and the M2 combat-core pass — A1 revisited + A2/A3/A5/A7/B2/B3)
